...
class Zero123PlusPlus(nn.Module):
    def __init__(self, device, fp16=True, t_range=[0.02, 0.98], model_key="sudo-ai/zero123plus-pipeline"):
        super().__init__()
...
if __name__ == '__main__':
    ...
    if opt.stable:
        zero123 = Zero123(device, model_key='sudo-ai/zero123plus-pipeline')
    else:
